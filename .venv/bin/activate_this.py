...
base = bin_dir[: -len('bin') - 1]  # ty: ignore[unresolved-reference]

# prepend bin to PATH (this file is inside the bin directory)
os.environ["PATH"] = os.pathsep.join([bin_dir, *os.environ.get("PATH", "").split(os.pathsep)])
os.environ["VIRTUAL_ENV"] = base  # virtual env is right above bin directory
os.environ["VIRTUAL_ENV_PROMPT"] = '' or os.path.basename(base)  # ty: ignore[unresolved-reference]
...
for lib in '../lib64/python3.14/site-packages:../lib/python3.14/site-packages'.split(os.pathsep):  # ty: ignore[unresolved-reference]
